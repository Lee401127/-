...
QT_MOC_LITERAL(3, 16, 6), // "change"
QT_MOC_LITERAL(4, 23, 11), // "updateFrame"
QT_MOC_LITERAL(5, 35, 4) // "turn"

    },
    "OpenVideo\0over\0\0change\0updateFrame\0"
    "turn"
};
...
void OpenVideo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (OpenVideo::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenVideo::over)) {
                *result = 0;
                return;
            }
        }
